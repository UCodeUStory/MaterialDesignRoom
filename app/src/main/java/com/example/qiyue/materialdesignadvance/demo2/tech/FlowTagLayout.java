...
public class FlowTagLayout extends ViewGroup {
    ...
    public Map<Integer, View> getmCheckedView() {
        return mCheckedView;
    }

    public void setmCheckedView(Map<Integer, View> mCheckedView) {
        this.mCheckedView = mCheckedView;
    }

    private Map<Integer,View> mCheckedView = new HashMap<Integer,View>();
     ...
     * @param position
     */
    public void setLableSelect(int position){
        getmCheckedView().get(position).setSelected(true);
